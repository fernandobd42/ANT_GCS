...
@WebServlet("/StudentIncludeController")
public class StudentIncludeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		result = ia.include(name, cpf, ra, email, sex, course, street, number, neighborhood, city, state, phone,
				lattes, linkedin);
		} catch (Exception e) {
			return;
		}		
